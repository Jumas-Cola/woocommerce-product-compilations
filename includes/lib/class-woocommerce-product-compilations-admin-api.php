 ...
 * Admin API class.
 */
class WooCommerce_Product_Compilations_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'woocommerce-product-compilations' ) . '" data-uploader_button_text="' . __( 'Use image', 'woocommerce-product-compilations' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'woocommerce-product-compilations' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'woocommerce-product-compilations' ) . '" />' . "\n";
